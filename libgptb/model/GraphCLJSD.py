...
class GraphCLJSD(AbstractGCLModel):
    def __init__(self, config, data_feature):
        ...
        if self.loss_type == 'JSD Loss':
            print("Using JSD Loss")
            self.contrast_model = DualBranchContrast(loss=L.DebiasedJSD(), mode='G2G').to(self.device)
        else:
