...
from libgptb.model.graphgps.layer.bigbird_layer import SingleBigBirdLayer
from libgptb.model.graphgps.layer.gatedgcn_layer import GatedGCNLayer
from libgptb.model.graphgps.layer.gine_conv_layer import GINEConvESLapPE
...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h, local_gnn_type, global_model_type, num_heads, act='relu',
                 ...
                 attn_dropout=0.0, layer_norm=False, batch_norm=False,
    ...
    def forward(self, x, edge_index, size=None):
        ...
        if self.local_model is not None:
            ...
            if self.local_gnn_type == 'CustomGatedGCN':
                local_out = self.local_model(Batch(batch=None,
                                                   x=h,
                ...
                if self.local_gnn_with_edge_attr:
                    h_local = self.local_model(h, edge_index, None)
                else:
